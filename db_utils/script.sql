...
CREATE TABLE IF NOT EXISTS `mydb`.`tour` (
                                             ...
                                             PRIMARY KEY (`tour_id`),
    INDEX `FK_property_id` (`property_id` ASC) ,
    INDEX `FK_client_id` (`client_id` ASC) )
    ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`property_location` (
    ...
    INDEX `FK_property_id` (`property_id` ASC) ,
    INDEX `FK_owner_id` (`owner_id` ASC) ,
    INDEX `FK_city_id` (`city_id` ASC) ,
    INDEX `FK_neighborhood_id` (`neighborhood_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`commission` (
    ...
    INDEX `FK_transaction_id` (`transaction_id` ASC) ,
